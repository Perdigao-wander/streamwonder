...
export default function ChannelsContent() {
    ...
    const updateURL = (params: { category?: string | null; q?: string; page?: number }) => {
        ...
        const newUrl = `/channels${urlParams.toString() ? `?${urlParams.toString()}` : ''}`;
    ...
    const handleCategorySelect = (categoryId: string | null) => {
        ...
        setCurrentPage(1);
        updateURL({ category: categoryId, q: '', page: 1 });
    };
    ...
    const handleSearch = () => {
        ...
        updateURL({ category: selectedCategory, q: tempSearchQuery, page: 1 });
    };
    ...
    const clearSearch = () => {
        ...
        setIsSearching(false);
        fetchChannels(selectedCategory);
        updateURL({ category: selectedCategory, q: '', page: currentPage });
    };
    ...
    const clearFilters = () => {
        ...
        setCurrentPage(1);
        fetchChannels(null);
        updateURL({ category: null, q: '', page: 1 });
    };
    ...
    const goToPage = (page: number) => {
        if (page >= 1 && page <= totalPages) {
            setCurrentPage(page);
            updateURL({ category: selectedCategory, q: searchQuery, page });
