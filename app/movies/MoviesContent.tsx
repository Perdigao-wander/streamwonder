...
import { Search, Filter, X, Star, ChevronLeft, ChevronRight, SearchIcon, Film } from 'lucide-react';
...
export default function MoviesContent() {
    ...
    const updateURL = useCallback((params: {
        ...
        if (sortValue && sortValue !== 'popularity.desc') {
    ...
    // Buscar quando os parâmetros mudarem
    useEffect(() => {
        setCurrentPage(1);
        fetchMovies(1, false);
                        ...
                        {showFilters && (
                            <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div>
                                        <label className="text-white text-sm block mb-2">Ano de lançamento</label>
                                        <select
                                            value={selectedYear}
                        ...
                        {movies.map((movie) => (
                            ...
                            >
                                ...
                                <p className="text-gray-400 text-xs">
                                    {movie.release_date?.split('-')[0] || 'Em breve'}
                                </p>
                            </div>
                        ))}
                    </div>
