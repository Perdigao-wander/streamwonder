// app/media/[mediaType]/[id]/page.tsx
// Ou: app/[mediaType]/[id]/page.tsx
        ...
        return (
            <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-950 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <h2 className="text-2xl font-bold text-white mb-2">Tipo de mídia inválido</h2>
                    <p className="text-gray-400 mb-6">A URL deve ser /movie/[id] ou /tv/[id]</p>
                    <button
                        onClick={handleBack}
