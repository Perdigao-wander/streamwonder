...
import { Search, Filter, X, Star, ChevronLeft, ChevronRight, SearchIcon, JapaneseYen } from 'lucide-react';
...
export default function AnimesContent() {
    ...
    const updateURL = useCallback((params: {
        ...
        const newUrl = `/animes${urlParams.toString() ? `?${urlParams.toString()}` : ''}`;
